...
echo validaCpf($cpf)."<br>";
echo validarNumeroCartao($numeroCartao)."<br>";
echo validarCvv($cvv)."<br>";
...
//  echo validarCampoVazio($nomeCompleto);
//  validarCampoVazio($cpf);
      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            <ul class="list-group">
            <li class="lis-group-item"><strong>Nome Curso:</strong><?php echo $nomeCurso ?></li>
            <li class="lis-group-item"><strong>Preço:</strong><?php echo $precoCurso ?></li>
            <li class="lis-group-item"><strong>Nome Completo:</strong><?php echo $nomeCompleto ?></li>
            </ul>
            <div class="center">
